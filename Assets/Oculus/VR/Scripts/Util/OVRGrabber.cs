...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            if (m_grabbedObj.snapScale)
            {
                m_grabbedObj.transform.localScale = m_grabbedObj.snapOffset.localScale;
            }
            ...
            if (m_grabbedObj.snapOrientation)
            {
                ...
                if(m_grabbedObj.snapOffset)
                {
                    ...
                    Vector3 rotOffset = m_grabbedObjectRotOff.eulerAngles;
                    Vector3 defRot = new Vector3(0, 0, 90);
                    ...
                    m_grabbedObjectRotOff = Quaternion.Euler(rotOffset);
                }
            }
            else
            {
